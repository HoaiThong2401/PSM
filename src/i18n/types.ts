...
export interface TranslationDictionary {
  ...
  analytics: {
    ...
    pageSubtitle: string;
    allTimeTotal: string;
    allTimeTotalSub: string;
    avgPerCycle: string;
    avgPerCycleSub: string;
    bestCycle: string;
    overallHitRate: string;
    overallHitRateSub: string;
    chartTitle: string;
    chartSubtitle: string;
    headToHeadTitle: string;
    headToHeadSubtitle: string;
    cycleA: string;
    cycleB: string;
    difference: string;
    diffCash: string;
    diffRate: string;
    successRateAndShifts: string;
    shifts: string;
    dayOfWeekTitle: string;
    dayOfWeekSubtitle: string;
    shiftsCount: string;
    tableTitle: string;
    ...
    top1: string;
    accumulatedAcross: string;
    cyclesCount: string;
    totalWorkedShifts: string;
    shiftsWorked: string;
  ...
  notifications: {
    ...
    activateNow: string;
    customizeSchedule: string;
    reason: string;
    morningShiftRuleTitle: string;
    morningShiftRuleReason: string;
    missingEntryRuleTitle: string;
    missingEntryRuleReason: string;
    cycleEndingRuleTitle: string;
    cycleEndingRuleReason: string;
    goalAchievedRuleTitle: string;
    goalAchievedRuleReason: string;
    timePickerTitle: string;
    morningPickerTitle: string;
    morningPickerDesc: string;
    eveningPickerTitle: string;
    eveningPickerDesc: string;
    quickPresets: string;
    applyBtn: string;
    ...
    pushUnsubscribedToast: string;
    pushSubscribeErrorToast: string;
    morningTimeChangedToast: string;
    eveningTimeChangedToast: string;
    clickToEditMorningTime: string;
    clickToEditEveningTime: string;
    increaseTime: string;
    decreaseTime: string;
  };
}
