      ...
      <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div className="space-y-4 max-w-xl">
          <div className="flex flex-wrap items-center gap-2.5">
            <span className="px-3 py-1 rounded-full bg-indigo-50 dark:bg-white/10 backdrop-blur-md text-xs font-semibold tracking-wide text-indigo-700 dark:text-indigo-200 border border-indigo-200/80 dark:border-white/10">
              📅 {dayLabel}, {formattedToday}
            </span>
            <Badge
              status={todayRecord?.status || 'processing'}
              size="md"
              className="bg-indigo-100/80 text-indigo-800 dark:bg-white/15 dark:text-white border-indigo-200 dark:border-white/20 backdrop-blur-md"
            />
            {isGoalReached && (
              <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-300 text-xs font-bold border border-emerald-200 dark:border-emerald-500/30 animate-pulse">
